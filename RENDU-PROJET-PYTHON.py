...
#A ce stade, on a enlevé la partie "+0200" de la date.
...
'2020-09-11 18:03:03 +0200'
'2020-09-11 18:48:03 +0200'
...
#def lectureFichier(fichier):
    #df=pd.read_csv(r'C:\Users\vboua\OneDrive\Documents\Cours\Informatique\Projet Info\Donnéesprojetinfo.csv',delimiter=';',header=0)
    #return df

#def timePlot(variable,df):
        #graph=pd.DataFrame({'x':df['sent_at'],'y':df[variable]})
        #graph.plot()


#df=lectureFichier(r'C:\Users\vboua\OneDrive\Documents\Cours\Informatique\Projet Info\Donnéesprojetinfo.csv')
